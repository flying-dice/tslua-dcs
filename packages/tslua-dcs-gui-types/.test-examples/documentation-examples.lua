...
["src.exports.DCS.export"] = function(...)
...
["src.exports.Export.export"] = function(...)
local ____lualib = require("lualib_bundle")
local __TS__SourceMapTraceBack = ____lualib.__TS__SourceMapTraceBack
local ____exports = {}
return ____exports
...
["src.exports.lfs.export"] = function(...)
local ____lualib = require("lualib_bundle")
local __TS__SourceMapTraceBack = ____lualib.__TS__SourceMapTraceBack
local ____exports = {}
return ____exports
...
["src.exports.log.export"] = function(...)
local ____lualib = require("lualib_bundle")
local __TS__SourceMapTraceBack = ____lualib.__TS__SourceMapTraceBack
local ____exports = {}
return ____exports
...
["src.exports.terrain.export"] = function(...)
local ____lualib = require("lualib_bundle")
local __TS__SourceMapTraceBack = ____lualib.__TS__SourceMapTraceBack
local ____exports = {}
return ____exports
 end,
["src.terrain"] = function(...)
local ____lualib = require("lualib_bundle")
local __TS__SourceMapTraceBack = ____lualib.__TS__SourceMapTraceBack
local ____exports = {}
return ____exports
...
do
    local ____export = require("src.DCS")
    for ____exportKey, ____exportValue in pairs(____export) do
        if ____exportKey ~= "default" then
            ____exports[____exportKey] = ____exportValue
        end
...
do
    local ____export = require("src.Export")
    for ____exportKey, ____exportValue in pairs(____export) do
        if ____exportKey ~= "default" then
            ____exports[____exportKey] = ____exportValue
        end
...
do
    local ____export = require("src.log")
    for ____exportKey, ____exportValue in pairs(____export) do
        if ____exportKey ~= "default" then
            ____exports[____exportKey] = ____exportValue
        end
...
do
    local ____export = require("src.db")
    for ____exportKey, ____exportValue in pairs(____export) do
        if ____exportKey ~= "default" then
            ____exports[____exportKey] = ____exportValue
        end
...
do
    local ____export = require("src.net")
    for ____exportKey, ____exportValue in pairs(____export) do
        if ____exportKey ~= "default" then
            ____exports[____exportKey] = ____exportValue
        end
...
local __TS__SourceMapTraceBack = ____lualib.__TS__SourceMapTraceBack
function expectEqual(self, actual, expected, example)
...
slots = DCS.getAvailableSlots(2)
expectEqual(nil, slots and slots[1].unitId, "101_2", "DCS.getAvailableSlots unitId")
expectEqual(
    nil,
    DCS.getAvailableSlots(0),
    nil,
    "DCS.getAvailableSlots optional return"
)
windX, windY, windZ, terrainHeight = Export.LoGetWindAtPoint(10, 1000, 30, false)
expectEqual(nil, windX, 4, "Export.LoGetWindAtPoint wind X")
expectEqual(nil, windY, 5, "Export.LoGetWindAtPoint wind Y")
expectEqual(nil, windZ, 6, "Export.LoGetWindAtPoint wind Z")
expectEqual(nil, terrainHeight, 120, "Export.LoGetWindAtPoint terrain height")
local ____Export_LoLoCoordinatesToGeoCoordinates_result_2 = Export.LoLoCoordinatesToGeoCoordinates(10, 30)
latitude = ____Export_LoLoCoordinatesToGeoCoordinates_result_2.latitude
longitude = ____Export_LoLoCoordinatesToGeoCoordinates_result_2.longitude
expectEqual(nil, latitude, 41.6103, "Export.LoLoCoordinatesToGeoCoordinates latitude")
expectEqual(nil, longitude, 41.5997, "Export.LoLoCoordinatesToGeoCoordinates longitude")
point = {x = 10, y = 1000, z = 30}
surface = Export.LoGetHeightWithObjects(point.x, point.z) or Export.LoGetAltitude(point.x, point.z)
expectEqual(nil, surface, 80, "Export.LoGetHeightWithObjects fallback")
local ____expectEqual_5 = expectEqual
local ____opt_3 = Export.LoGetSelfData()
____expectEqual_5(nil, ____opt_3 and ____opt_3.Name, nil, "Export.LoGetSelfData optional")
expectEqual(
    nil,
    #(Export.LoGetTargetInformation() or ({})),
    0,
    "Export.LoGetTargetInformation fallback"
)
expectEqual(
    nil,
    #(Export.LoGetLockedTargetInformation() or ({})),
    0,
    "Export.LoGetLockedTargetInformation fallback"
)
local ____expectEqual_8 = expectEqual
local ____opt_6 = Export.LoGetTWSInfo()
____expectEqual_8(nil, #(____opt_6 and ____opt_6.Emitters or ({})), 0, "Export.LoGetTWSInfo fallback")
local ____expectEqual_11 = expectEqual
local ____opt_9 = Export.LoGetPayloadInfo()
____expectEqual_11(nil, ____opt_9 and ____opt_9.Cannon.shells, nil, "Export.LoGetPayloadInfo optional")
expectEqual(
    nil,
    Export.LoGetPlayerUnitId(),
    nil,
    "Export.LoGetPlayerUnitId optional"
)
request = Export.LoCreateCameraRequest()
if request then
    Export.LoForceCamera(request)
end
expectEqual(nil, documentationForcedCamera and documentationForcedCamera.name, "CameraCockpit", "Export.LoForceCamera")
 end,
}
local __TS__SourceMapTraceBack = require("lualib_bundle").__TS__SourceMapTraceBack
__TS__SourceMapTraceBack(debug.getinfo(1).short_src, {["2855"] = {line = 10, file = "index.ts"},["2863"] = {line = 11, file = "index.ts"},["2871"] = {line = 12, file = "index.ts"},["2879"] = {line = 13, file = "index.ts"},["2887"] = {line = 14, file = "index.ts"},["2895"] = {line = 15, file = "index.ts"},["2914"] = {line = 5, file = "documentation-examples.ts"},["2915"] = {line = 6, file = "documentation-examples.ts"},["2917"] = {line = 7, file = "documentation-examples.ts"},["2918"] = {line = 7, file = "documentation-examples.ts"},["2919"] = {line = 7, file = "documentation-examples.ts"},["2920"] = {line = 7, file = "documentation-examples.ts"},["2924"] = {line = 5, file = "documentation-examples.ts"},["2925"] = {line = 12, file = "documentation-examples.ts"},["2926"] = {line = 13, file = "documentation-examples.ts"},["2927"] = {line = 14, file = "documentation-examples.ts"},["2928"] = {line = 14, file = "documentation-examples.ts"},["2929"] = {line = 15, file = "documentation-examples.ts"},["2930"] = {line = 16, file = "documentation-examples.ts"},["2931"] = {line = 17, file = "documentation-examples.ts"},["2932"] = {line = 14, file = "documentation-examples.ts"},["2933"] = {line = 21, file = "documentation-examples.ts"},["2934"] = {line = 27, file = "documentation-examples.ts"},["2935"] = {line = 28, file = "documentation-examples.ts"},["2936"] = {line = 29, file = "documentation-examples.ts"},["2937"] = {line = 30, file = "documentation-examples.ts"},["2938"] = {line = 33, file = "documentation-examples.ts"},["2939"] = {line = 33, file = "documentation-examples.ts"},["2940"] = {line = 33, file = "documentation-examples.ts"},["2941"] = {line = 34, file = "documentation-examples.ts"},["2942"] = {line = 39, file = "documentation-examples.ts"},["2943"] = {line = 46, file = "documentation-examples.ts"},["2944"] = {line = 47, file = "documentation-examples.ts"},["2945"] = {line = 50, file = "documentation-examples.ts"},["2946"] = {line = 51, file = "documentation-examples.ts"},["2947"] = {line = 52, file = "documentation-examples.ts"},["2948"] = {line = 51, file = "documentation-examples.ts"},["2949"] = {line = 56, file = "documentation-examples.ts"},["2950"] = {line = 56, file = "documentation-examples.ts"},["2951"] = {line = 57, file = "documentation-examples.ts"},["2952"] = {line = 58, file = "documentation-examples.ts"},["2953"] = {line = 59, file = "documentation-examples.ts"},["2954"] = {line = 56, file = "documentation-examples.ts"},["2955"] = {line = 61, file = "documentation-examples.ts"},["2956"] = {line = 61, file = "documentation-examples.ts"},["2957"] = {line = 62, file = "documentation-examples.ts"},["2958"] = {line = 63, file = "documentation-examples.ts"},["2959"] = {line = 64, file = "documentation-examples.ts"},["2960"] = {line = 61, file = "documentation-examples.ts"},["2961"] = {line = 66, file = "documentation-examples.ts"},["2962"] = {line = 67, file = "documentation-examples.ts"},["2963"] = {line = 66, file = "documentation-examples.ts"},["2964"] = {line = 71, file = "documentation-examples.ts"},["2965"] = {line = 72, file = "documentation-examples.ts"},["2966"] = {line = 71, file = "documentation-examples.ts"},["2967"] = {line = 76, file = "documentation-examples.ts"},["2968"] = {line = 76, file = "documentation-examples.ts"},["2969"] = {line = 77, file = "documentation-examples.ts"},["2970"] = {line = 78, file = "documentation-examples.ts"},["2971"] = {line = 79, file = "documentation-examples.ts"},["2972"] = {line = 76, file = "documentation-examples.ts"},["2973"] = {line = 83, file = "documentation-examples.ts"},["2974"] = {line = 84, file = "documentation-examples.ts"},["2975"] = {line = 84, file = "documentation-examples.ts"},["2977"] = {line = 85, file = "documentation-examples.ts"}});
