...
export interface _world {
	...
	eventHandlers: {
		/**
		 * Omitted 1 non-representable Lua key(s) at "world.eventHandlers";
		 * their values are unknown because TypeScript cannot name Lua table keys.
		 */
	};
	getAirbases(...args: any[]): unknown;
	getMarkPanels(...args: any[]): unknown;
	getPersistenceData(...args: any[]): unknown;
	...
	runPersistenceHandlers(...args: any[]): unknown;
	searchObjects(...args: any[]): unknown;
	setPersistenceHandler(...args: any[]): unknown;
	setPersistencePassthrough(...args: any[]): unknown;
	weather: {
